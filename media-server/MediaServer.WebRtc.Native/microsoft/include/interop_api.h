...
extern "C"
{
    ...
    inline uint32_t operator&(mrsDataChannelConfigFlags a, mrsDataChannelConfigFlags b) noexcept
    {
    ...
    enum class FrameHeightRoundMode : int32_t
    {
        kNone = 0,
        kCrop = 1,
        kPad = 2

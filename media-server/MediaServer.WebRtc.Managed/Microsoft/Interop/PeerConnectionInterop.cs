...
namespace Microsoft.MixedReality.WebRTC.Interop
{
    ...
    internal class PeerConnectionInterop
    {
        ...
        public class PeerCallbackArgs
        {
            ...
            public LocalVideoTrackInterop.VideoFrameUnmanagedCallback RemoteVideoFrameCallback;
        ...
        [MonoPInvokeCallback(typeof(LocalVideoTrackInterop.VideoFrameUnmanagedCallback))]
        public static void RemoteVideoFrameCallback(IntPtr userData, IntPtr frame)
        {
            var peer = Utils.ToWrapper<PeerConnection>(userData);
            peer.OnRemoteVideoFrameReady(frame);
        }
        ...
        [DllImport(Utils.dllPath, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi,
            EntryPoint = "mrsPeerConnectionRegisterRemoteVideoFrameCallback")]
        public static extern void PeerConnection_RegisterRemoteVideoFrameCallback(PeerConnectionHandle peerHandle,
            LocalVideoTrackInterop.VideoFrameUnmanagedCallback callback, IntPtr userData);
        ...
        /// </summary>
        [DllImport(Utils.dllPath, CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi,EntryPoint = "mrsPeerConnectionAddPassiveVideoTrack")]
        public static extern void PeerConnection_AddPassiveVideoTrack(PeerConnectionHandle peerHandle, PassiveVideoTrackSafeHandle passiveVideoTrack);

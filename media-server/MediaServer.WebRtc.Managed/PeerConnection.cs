...
namespace Microsoft.MixedReality.WebRTC
{
    ...
    public class PeerConnection : IDisposable
    {
        ...
        /// <summary>
        /// Occurs when remote video frame ready
        /// </summary>
        public event VideoFrameDelegate RemoteVideoFrameReady;
        ...
        public Task InitializeAsync(PeerConnectionConfiguration config = null, CancellationToken token = default)
        {
            lock(_openCloseLock)
            {
                ...
                _peerCallbackArgs = new PeerConnectionInterop.PeerCallbackArgs()
                {
                    ...
                    RemoteVideoFrameCallback = PeerConnectionInterop.RemoteVideoFrameCallback,
                ...
                _initTask = Task.Run(() =>
                {
                    ...
                    lock(_openCloseLock)
                    {
                        ...
                        PeerConnectionInterop.PeerConnection_RegisterRemoteVideoFrameCallback(
                            _nativePeerhandle, _peerCallbackArgs.RemoteVideoFrameCallback, self);
        ...
        /// </summary>
        public void AddPassiveVideoTrack(PassiveVideoTrack passiveVideoTrack)
        {
            PeerConnectionInterop.PeerConnection_AddPassiveVideoTrack(_nativePeerhandle, passiveVideoTrack.Native);
        }
        ...
        internal void OnRemoteVideoFrameReady(IntPtr frame) => RemoteVideoFrameReady?.Invoke(frame);
